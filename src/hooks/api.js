...
const sendTgId = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/', data);
...
const updateBalance = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/update-balance', data);
...
const getReferralList = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/referral', data);
...
const boostInfo = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/boost', data);
...
const sendBalanceRoute = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/boost1', data);
...
const boostUpdate = async (data) => {
    try {
        const response = await axios.post('https://wolfchik.space:443/update-boost-info', data);
